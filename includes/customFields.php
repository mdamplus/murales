<?php
// Agregar campos adicionales para la imagen destacada y descripción en taxonomías
...
function agregarCustomFieldsArtista($post) {
    ...
    wp_nonce_field('guardar_custom_fields', 'artista_nonce'); // Añadir nonce
    ?>
...
add_action('save_post', 'guardarCustomFieldsArtista');
